...
/** One-shot GET JSON from a real tab on the service's site. */
export async function getJsonViaTab(service, url, opts = {}) {
  return withServiceTab(service, opts, (fetchJson) => fetchJson(url, { headers: opts.headers }))
}
